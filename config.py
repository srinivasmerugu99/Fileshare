...
#--------------------------------------------
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "8810354889:AAGPNMmHDJBDYsHHBRz57_TJ5NlQnWDySwc")
APP_ID = int(os.environ.get("APP_ID", "31235022")) #Your API ID from my.telegram.org
API_HASH = os.environ.get("API_HASH", "64a8cdb2c92d7ac433765af3e65dabb1") #Your API Hash from my.telegram.org
#--------------------------------------------

CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1004322372866")) #Your db channel Id
OWNER = os.environ.get("OWNER", "Baddakam_Bob") # Owner username without @
OWNER_ID = int(os.environ.get("OWNER_ID", "8202727275")) # Owner id
#--------------------------------------------
